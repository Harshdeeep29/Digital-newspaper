...
const useSports = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get('https://newsapi.org/v2/top-headlines?country=us&category=entertainment&apiKey=b7960abe6a064a35b8aab97636f707bf');
    ...
    return ( <>
    <Entertainment leftcard={leftcard}
    rightcard={rightcard}
    error={error}
    />
    </> );
